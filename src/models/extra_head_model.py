...
class ExtrHeadEventModule(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        optimizer2 = get_optimizer(self.hparams.optimizers[1]['name'], torch.nn.Sequential(self.net.parameters(),self.head.parameters()).parameters(), self.hparams.optimizers[1]['params'])
