...
class CCNN(nn.Module):
    def __init__(
        ...
        self.final_list = nn.ModuleList([ContConv1dSim(Kernel(hidden_1, hidden_2, hidden_3, nb_filters, nb_filters), 1, nb_filters, nb_filters), nn.ReLU(), nn.Linear(nb_filters, num_types), nn.Softplus(0.01)])
