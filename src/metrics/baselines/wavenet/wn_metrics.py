...
class WNMetrics(MetricsCore):
    def __init__(self, return_time_metric: Any, event_type_metric: Any) -> None:
    ...
    def type_loss(self, prediction: torch.Tensor, types: torch.Tensor) -> torch.Tensor:
        ...
        args:
            prediction: predicted event types
            types: true event types

        returns:
            loss - value of type-prediction loss function (cross entropy)
        """
